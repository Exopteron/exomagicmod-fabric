...
public class ItemSetup {
    ...
    public static void run(TestMod main) {
        ...
        Registry.register(Registry.ITEM, "exomagicmod:energy_crystal", ENERGY_CRYSTAL);
        Registry.register(Registry.ITEM, "exomagicmod:magic_wand", MAGIC_WAND);

        settings = new Item.Settings();
        settings.fireproof();
        settings.group(TestMod.CREATIVE_TAB);
        NETHERITE_STICK = new TooltippableItem(settings, Text.of("A stick. But out of netherite."));
        Registry.register(Registry.ITEM, "exomagicmod:netherite_stick", NETHERITE_STICK);
    }   
}
